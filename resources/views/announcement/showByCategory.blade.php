<x-layout>
    ...
    <div class="container">
        ...
        <div class="col-12 messaggioCustom text-center">
            <h1>{{__('ui.noAnnunciCategoria')}}</h1>
        </div>    
        </div>      
    </div> 
    @else
    <div class="container py-5 my-5 que">
        ...
        <div class="row justify-content-center align-items-center">
            <div class="col-12 d-flex justify-content-center text-rosso">
                {{$announcements->links()}}
            </div>
        </div>
    </div>
